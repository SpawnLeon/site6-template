  ...
  <div class="catalog-card__option card-option" :class="{'card-option--open':isItemOpen === true}">
        ...
        <div class="card-option__inner" @click="onFocus">
             <div class="card-option__value">
                  <div class="card-option-item__image" v-if="mutableValue">
          ...
          <ul
              ...
              <li v-for="(item,index) in options" :class="{'card-option__item card-option-item':true,'card-option-item--selected':index === pointer}"
