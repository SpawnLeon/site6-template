...
var SnowFall = new Snow("#Snow", {
  images: [
    "/local/templates/mebel/images/img/flake1.png",
    "/local/templates/mebel/images/img/flake2.png",
    "/local/templates/mebel/images/img/flake3.png",
    "/local/templates/mebel/images/img/flake4.png",
    "/local/templates/mebel/images/img/flake5.png",
    "/local/templates/mebel/images/img/flake6.png",
    "/local/templates/mebel/images/img/flake7.png"
  ]
});
